...
<div class="bg-gradient-to-br from-primary/10 via-cream to-secondary/10">
  <div class="container mx-auto px-6 py-16">
    <div class="max-w-3xl mx-auto text-center">
      ...
      <p class="text-lg text-gray-700 mb-10 leading-relaxed max-w-2xl mx-auto">
...
<div class="bg-gray-900 text-white py-12">
  <div class="container mx-auto px-6 text-center">
    ...
    <p class="text-gray-300 mb-6 max-w-2xl mx-auto">
      Lead a bike train in your neighborhood, follow us on social media, or reach out with questions.
    </p>
    <a href="/create" class="btn btn-primary inline-block mb-8">
      Create your own ride →
    </a>
