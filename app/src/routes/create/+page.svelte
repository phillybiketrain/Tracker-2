  ...
  <div class="container mx-auto px-6 py-12">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card text-center py-16">
          ...
          <div class="mt-8 p-4 bg-blue-50 border border-blue-200 rounded text-sm text-blue-800 text-left max-w-2xl mx-auto">
            ...
            <ul class="mt-2 space-y-1 list-disc list-inside">
              <li>The ride {createdMode === 'recurring' ? 'series' : ''} now shows up on the <a href="/" class="underline">home page</a> and may be picked up by other ride apps.</li>
              <li>
                {#if createdMode === 'recurring'}
      ...
      {:else}
        ...
        <!-- Heads-up: published rides are public and may appear elsewhere -->
        <div class="card mb-8 flex items-start gap-3">
          <svg class="w-5 h-5 text-warm-gray-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
