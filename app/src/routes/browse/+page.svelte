...
<div class="container mx-auto px-6 py-8">
  ...
  <a
    href="/map"
    class="block mb-10 rounded-2xl bg-gradient-to-r from-primary to-blue-600 text-white p-6 hover:shadow-lg transition-all group"
  >
    <div class="flex items-center justify-between gap-4">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-xl sm:text-2xl font-bold mb-1">See all rides on the map</h2>
          <p class="text-blue-100 text-sm sm:text-base">A visual overview of every ride</p>
        </div>
      </div>
  ...
  <div class="mt-16 max-w-2xl mx-auto text-center bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-10 border border-white">
    ...
    <p class="text-warm-gray-600 mb-6">
      Start your own bike train — publish your route and let people follow along live.
    </p>
